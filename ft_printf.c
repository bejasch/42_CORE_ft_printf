...
/*   Updated: 2024/05/06 12:35:11 by bschneid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

int	use_func(va_list args, const char **input, t_subs *subs)
{
	if (**input == 'c')
...
void	care_flags(const char **input, t_subs *subs)
{
	subs->flag_minus = 0;
	subs->flag_plus = 0;
	subs->flag_space = 0;
...
int	handle_specifier(va_list args, const char **input, t_subs *subs)
{
...
int	handle_input(va_list args, const char **input, t_subs *subs)
{
	char	*save;
	int		out;
